                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-start">
                    <input
                      ...
                      className="h-4 w-4 mt-1 mr-3 rounded border-gray-300 text-[#00E8E5] focus:outline-none focus:ring-2 focus:ring-[#00E8E5]/50 focus:border-[#00E8E5] transition-colors"
                    />
                  ...
                  {status === 'success' && (
                    <div className="bg-green-50 border-2 border-green-500 text-green-700 px-4 py-3 rounded-lg" role="alert">
